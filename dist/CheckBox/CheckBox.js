...
export const CheckBox = (_a) => {
    ...
    const iconProps = Object.assign({ checked,
        onLongPress,
        checkedColor }, rest);
    return (<Component accessibilityRole="checkbox" accessibilityState={accessibilityState} testID="checkbox" {...rest} onLongPress={onLongPress} onPress={onPress} style={StyleSheet.flatten([
        styles.container,
